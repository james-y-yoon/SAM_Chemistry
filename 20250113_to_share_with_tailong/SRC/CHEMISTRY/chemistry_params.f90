module chemistry_params
   ...
   logical :: do_O3_photolysis = .true.
   logical :: do_H2O2_photolysis = .true.
   logical :: do_HCHO_photolysis = .true.
   logical :: do_NO3_photolysis = .true.
   logical :: do_ISOPOOH_photolysis = .true.
