...
!     
   ...
   if(STATUS.eq.NF_NOERR) then
     ...
     if(status.eq.NF_NOERR) then
       do n = 1,ntime
         if (flip_aero_sound) then
            AccumAerosolNumber_snd(1:nlev,n) = tmp_aer_in(n,nlev:1:-1)
         else
            AccumAerosolNumber_snd(1:nlev,n) = tmp_aer_in(n,1:nlev)
         end if
       end do
     end if
     ...
     if(status.eq.NF_NOERR) then
       do n = 1,ntime
         if (flip_aero_sound) then
            ...
            AccumAerosolMass_snd(1:nlev,n) = tmp_aer_in(n,1:nlev)
         end if
       end do
     end if
     ...
     if(status.eq.NF_NOERR) then
       do n = 1,ntime
         if (flip_aero_sound) then
           ...
           AitkenAerosolNumber_snd(1:nlev,n) = tmp_aer_in(n,1:nlev)
         end if
       end do
     end if
     ...
     if(status.eq.NF_NOERR) then
       do n = 1,ntime
         if (flip_aero_sound) then
            ...
            AitkenAerosolMass_snd(1:nlev,n) = tmp_aer_in(n,1:nlev)
         end if
       end do
     end if
