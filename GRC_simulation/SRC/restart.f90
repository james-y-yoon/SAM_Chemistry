...
! (just in case when some parameterization initializes and needs boundary points)
        ...
        write(65)  &
         ...
         tracer, micro_field, gchem_field, aqchem_field, aqchem_gasprod_field, archem_field, sgs_field, sgs_field_diag, z, pres, prespot, presi, &
        ...
        use movies, only: irecc
        implicit none
        integer  nx1, ny1, nz1, rank1, ntr, nmic, ngchem, naqchem, narchem, nsgs, nsgsd
