...
! RCONST(16) = constant rate coefficient
  RCONST(17) = (k_T(8.e-12,380.,T))
  RCONST(18) = ((KFPAN))
  RCONST(19) = ((KBPAN))
  RCONST(20) = ((KRO2NO))
! RCONST(21) = constant rate coefficient
  RCONST(22) = (k_T(1.05E-11,465.,T))
  RCONST(23) = (k_T(2.6E-12,610.,T))
  RCONST(24) = (k_T(1.05e-11,465.,T))
  RCONST(25) = (k_T(1.05e-11,465.,T))
  RCONST(26) = (k_T(2.07e-12,-1400.,T))
  RCONST(27) = (k_T(3.r5e-12,270.,T))
