...
elseif(field.gt.4+nsgs_fields+nsgs_fields_diag+nmicro_fields+ntracers.and. &
                        field.le.4+nsgs_fields+nsgs_fields_diag+nmicro_fields+ntracers+ngchem_fields) then

  call task_assign_bnd(gchem_field(:,:,:,field-4-nsgs_fields-nsgs_fields_diag-nmicro_fields-ntracers),&
       dimx1_s,dimx2_s,dimy1_s,dimy2_s,nzm,buff,tag)

elseif(field.gt.4+nsgs_fields+nsgs_fields_diag+nmicro_fields+ntracers+ngchem_fields.and. &
                        field.le.4+nsgs_fields+nsgs_fields_diag+nmicro_fields+ntracers+ngchem_fields+naqchem_fields) then

  call task_assign_bnd(aqchem_field(:,:,:,field-4-nsgs_fields-nsgs_fields_diag-nmicro_fields-ntracers-ngchem_fields),&
       dimx1_s,dimx2_s,dimy1_s,dimy2_s,nzm,buff,tag)


elseif(field.gt.4+nsgs_fields+nsgs_fields_diag+nmicro_fields+ntracers+ngchem_fields+naqchem_fields.and. &
                        field.le.4+nsgs_fields+nsgs_fields_diag+nmicro_fields+ntracers+ngchem_fields+naqchem_fields*2) then

  call task_assign_bnd(aqchem_gasprod_field(:,:,:,field-4-nsgs_fields-nsgs_fields_diag-nmicro_fields-ntracers-ngchem_fields-naqchem_fields),&
       dimx1_s,dimx2_s,dimy1_s,dimy2_s,nzm,buff,tag)

elseif(field.gt.4+nsgs_fields+nsgs_fields_diag+nmicro_fields+ntracers+ngchem_fields+naqchem_fields*2.and. &
                        field.le.4+nsgs_fields+nsgs_fields_diag+nmicro_fields+ntracers+ngchem_fields+naqchem_fields*2+narchem_fields) then

  call task_assign_bnd(archem_field(:,:,:,field-4-nsgs_fields-nsgs_fields_diag-nmicro_fields-ntracers-ngchem_fields-naqchem_fields*2),&
       dimx1_s,dimx2_s,dimy1_s,dimy2_s,nzm,buff,tag)  
